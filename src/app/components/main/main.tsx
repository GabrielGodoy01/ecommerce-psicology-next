    ...
    return (
        <div className="flex flex-col items-center max-w-screen-2xl h-full box-border p-6 lg:flex-row">
            <div className="flex-1 flex flex-col justify-center lg:pr-12">
                ...
                <iframe className="flex-1 flex items-center justify-center w-full md:w-2/4 lg:h-2/4" src="https://www.youtube.com/embed/mX_BViO9OV4?si=nHhODwQTDqOkHHc2" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
        </div>
    )
}