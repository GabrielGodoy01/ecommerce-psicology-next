    ...
    return (
        <div className="flex flex-col lg:flex-row max-w-screen-2xl box-border items-center justify-center mx-6 my-6">
            ...
            <div className="flex-1 h-2/4 lg:h-3/4 flex-col items-center lg:items-start justify-center lg:pl-16">
                ...
                <p className='text-sm lg:text-base text-justify pt-4 lg:pt-4'>Our ebook blends cutting-edge research with empathetic insights to present a comprehensive guide to navigating anxiety. The content includes:</p>
